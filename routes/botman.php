...
$botman->hears('play mia.*', \App\Http\Controllers\MiaBotController::class.'@host');
...
$botman->hears('start game', \App\Http\Controllers\MiaBotController::class.'@start');
...
$botman->hears('([1-9]{0,1}[0-9]+(,|.)[0-6]|small mia|mia|shake)', \App\Http\Controllers\MiaBotController::class.'@playRound');
