    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding: 70px;padding-bottom: 100px;text-align: center">
                <h1 class="title-text">Play Mia on Slack!</h1>
                ...
                <a href="https://slack.com/oauth/authorize?client_id=248125203971.269100408786&scope=bot"><img
...
<div class="container" style="padding-top: 50px">
    <div class="row" style="margin-top: 50px">
        <div class="col-md-6 hidden-md hidden-lg">
            ...
            <p style="font-size: 16px;line-height: 1.7;">Play Mia by inviting the bot to a channel of your
